...
class booksTable extends Seeder
{
    ...
    public function run()
    {
        DB::table('books')->insert([
            ...
            'tiendaImagen' => 'portada-libroAless.png',
        ...
        DB::table('books')->insert([
            ...
            'descuentoDigital' => '0',
            'descuentoAudio' => '0',
            'sinopsis' => 'Estefania Licea se presenta a través de la tormenta que son sus poemas, este, su primer libro que,
            sin pretender ser desde la concepción algo más que lo que es: la diaria búsqueda del amor en todas sus formas de vida;
            se convierte, por mérito propio, en una voz para todas, las que siguen y las que fueron arrancadas, para ti, para mi,
            ...
            'tiendaImagen' => 'portada-libro-2Esteffania.png',
        ...
        DB::table('books')->insert([
            ...
            'tiendaImagen' => 'portada-libro-Jordan.png',
        ...
        DB::table('books')->insert([
            ...
            'portadaImagen' => 'portada-libro-Agus.png',
            'bannerImagen' => 'agustin.png',
            'tiendaImagen' => 'Portada-mockup-Agustin.png',
            'fechaPublicacion' => '2020-08-08',
            'nuevo' => 1,
            'sello_id' => '1',
            'paginas' => '100'
