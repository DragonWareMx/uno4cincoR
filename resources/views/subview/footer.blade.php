        ...
        <div>
          ...
          <div>
            {{-- <p class="footernav">
                ...
                <a href=""><img class="logodragon" src="{{ asset('img/ico/gps.png') }}">&nbsp;Montecito 38, Nápoles, Benito Juárez, 03810 Ciudad de México, CDMX</a><br>
                <a href=""><img class="logodragon" src="{{ asset('img/ico/email.png') }}">&nbsp; correo@gmail.com</a><br>
            </p> --}}
            <ul>
                <li>
                    <a href="tel:7221834383"><img class="logodragon" src="{{ asset('img/ico/phone.png') }}">&nbsp;722 6145 553</a><br>
                </li>
                <li>
    ...
    <div class="footer-right">
      ...
      <div>
        ...
        <div class="footer-icons">
            ...
            <a href="https://www.facebook.com/El-Booke-404763476744688" target="blank"><img src="{{ asset('img/ico/fb.png') }}" width="22px"></a>
            <a href="https://www.instagram.com/elbooke/" target="blank"><img src="{{ asset('img/ico/ig.png') }}" width="22px"></a>
            <a href="https://www.tiktok.com/@el_booke" target="blank"><img src="{{ asset('img/ico/tiktok.png') }}" width="20x"></a>
        </div>
    </div>
  </footer>