            ...
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  ...
                  @endforeach
                  @php
                    $precioTotal += $libroV->precio * $libroV->cantidad;               
                  @endphp
                  <td align="left" width="20%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">${{ number_format($libroV->precio * $libroV->cantidad, 2)}}</td>
                </tr>
                @endforeach
                <tr>
