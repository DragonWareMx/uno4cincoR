        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="www.elbooke.com" target="_blank" style="display: inline-block;">
                <img src="{{asset('img/logos/ElBooke.PNG')}}" alt="Logo" border="0" width="250"
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              ...
              <p style="margin: 0;">Hola {{$sell->nombreCliente}}. Gracias por tu compra en elbooke realizada el
                {{date('d-m-Y', strtotime($sell->fecha))}}. <br><br> <strong>Este es tu pedido</strong></p>
            </td>
          </tr>
          <!-- end copy -->
          @php
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="left" bgcolor="#83D7B5" width="10%"
                    style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <strong>&nbsp;</strong>
                  </td>
                  <td align="left" bgcolor="#83D7B5" width="70%"
                    style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <strong>Orden #</strong>
                  </td>
                  <td align="left" bgcolor="#83D7B5" width="20%"
                    style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <strong>{{ str_pad($sell->id,6,'0',STR_PAD_LEFT) }}</strong>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td align="left" width="70%"
                    style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    {{$libro->titulo}} (Digital - Preventa)</td>
                  @else
                  <td align="left" width="70%"
                    style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    {{$libro->titulo}} (Físico - Preventa)</td>
                  @endif
                  @endif
                  @endforeach
                  @php
                  ...
                  <td align="left" width="20%"
                    style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    &nbsp;${{ number_format($libroV->precio, 2)}}</td>
                </tr>
                @endforeach
                ...
                <tr>
                  ...
                  <td align="left" width="20%"
                    style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    -${{ number_format($sell->discount, 2)}}</td>
                </tr>
                @php
                ...
                <tr>
                  ...
                  <td align="left" width="70%"
                    style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    {{$sell->nombre_envio}}</td>
                  <td align="left" width="20%"
                    style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    &nbsp;${{ number_format($sell->precio_envio, 2)}}</td>
                </tr>
                @php
                ...
                <tr>
                  ...
                  <td align="left" width="20%"
                    style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;">
                    <strong> &nbsp;${{ number_format($precioTotal, 2)}}</strong>
                  </td>
                </tr>
              </table>
            </td>
      ...
      <td align="center" bgcolor="#83D7B5" style="padding: 24px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#83D7B5"
              style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">© 2020 elbooke.</p>
