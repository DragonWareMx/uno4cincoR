                ...
                <div class="compra-table">
                    <div class="compra-cell cell-80">
                        ...
                        <div class="formulario-container">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" autocomplete="given-name" id="fname" name="fname" value=""
                                ...
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" autocomplete="family-name" id="lname" name="lname" value=""
                                            onchange="this.setAttribute('value', this.value);" required>
                            ...
                            <div class="row" style="margin-bottom: 16px">
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="number" autocomplete="on" id="age" name="age" value=""
                                            onchange="this.setAttribute('value', this.value);" min="10" required>
                                        <label for="age" title="Edad" data-title="Edad"></label>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="field">
                                        <select name="genero" autocomplete="on" id="genero" value="" autocomplete="sex"
                                            required>
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    <input type="tel" autocomplete="tel" id="tel" name="tel" value=""
                                        onchange="this.setAttribute('value', this.value);" required>
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    <input type="text" autocomplete="on" id="ciudad" name="ciudad" value=""
                                        onchange="this.setAttribute('value', this.value);" required>
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    <input type="text" autocomplete="on" id="colonia" name="colonia" value=""
                                        onchange="this.setAttribute('value', this.value);" required>
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    <input type="text" autocomplete="street-address" id="calle" name="calle" value=""
                                        onchange="this.setAttribute('value', this.value);" required>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" autocomplete="on" id="numCasa" name="numCasa" value=""
                                ...
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" pattern="[0-9]*" autocomplete="postal-code" id="cp" name="cp"
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    <input type="text" autocomplete="on" id="referencias" name="referencias" value=""
                                        onchange="this.setAttribute('value', this.value);">
                    ...
                    <div class="compra-cell cell-20">
                        <div class="compra-container">
                            ...
                            <div class="productos-compra">
                                <div class="producto-table">
                                    ...
                                    <div class="producto-row">
                                        ...
                                        <div class="producto-cell contenido-producto-sm">
                                            <p>${{ number_format(($libro->precioFisico -
                                                $libro->precioFisico*($libro->descuentoFisico/100))*$details['cantidadFisico'],
                                                2 , ".", "," ) }}</p>
                                            @php
                                            $total += ($libro->precioFisico -
                                            $libro->precioFisico*($libro->descuentoFisico/100))*$details['cantidadFisico'];
                                            @endphp
                                        </div>
                                    </div>
                                    ...
                                    <div class="producto-row">
                                        ...
                                        <div class="producto-cell contenido-producto-sm">
                                            <p>${{ number_format(($libro->precioDigital -
                                                $libro->precioDigital*($libro->descuentoDigital/100)), 2 , ".", "," ) }}
                                            </p>
                                            @php
                                            $total += ($libro->precioDigital -
                                            $libro->precioDigital*($libro->descuentoDigital/100));
                                            @endphp
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div class="producto-table">
                                    <div class="producto-row">
                                        ...
                                        <div class="totales">
                                            <p>Envío</p>
                                            <p id="envio-totales" class="envio-totales">Selecciona el tipo de envío</p>
                                        </div>
                                        @else
                            ...
                            <button onclick="location.href='{{ route('inicio') }}'" class="boton_compra shrink">Regresar
                                a la tienda</button>
                            @endif
                        </div>
                    </div>
