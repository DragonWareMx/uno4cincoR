                    ...
                    <div class="compra-cell cell-80">
                        ...
                        <div class="formulario-container">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" autocomplete="given-name" id="fname" name="fname"
                                ...
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" autocomplete="family-name" id="lname" name="lname"
                                            value="" onchange="this.setAttribute('value', this.value);" required>
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    ...
                                    <label for="email" title="Correo electrónico"
                                        data-title="Correo electrónico"></label>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-bottom: 16px">
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="number" autocomplete="on" id="age" name="age"
                                ...
                                <div class="col-sm">
                                    <div class="field">
                                        <select name="genero" autocomplete="on" id="genero" value=""
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" autocomplete="on" id="countryId" name="country"
                                            value="" onchange="this.setAttribute('value', this.value);"
                                            required>
                                ...
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" autocomplete="on" id="stateId" name="state"
                                            value="" onchange="this.setAttribute('value', this.value);"
                                            required>
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    <input type="text" autocomplete="on" id="ciudad" name="ciudad"
                                        value="" onchange="this.setAttribute('value', this.value);" required>
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    <input type="text" autocomplete="on" id="colonia" name="colonia"
                                        value="" onchange="this.setAttribute('value', this.value);" required>
                            ...
                            <div class="row row-p">
                                <div class="field">
                                    <input type="text" autocomplete="street-address" id="calle"
                                        name="calle" value=""
                                        onchange="this.setAttribute('value', this.value);" required>
                                    <label for="calle" title="Calle y número de casa"
                                        data-title="Calle y número de casa"></label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" autocomplete="on" id="numCasa" name="numCasa"
                                            value="" onchange="this.setAttribute('value', this.value);">
                                        <label for="numCasa" title="Número interior (opcional)"
                                            data-title="Número interior (opcional)"></label>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="field">
                                        <input type="text" pattern="[0-9]*" autocomplete="postal-code"
                                            id="cp" name="cp" value=""
                                            onchange="this.setAttribute('value', this.value);" required>
                                        <label for="cp" title="Código Postal"
                            ...
                            @if ($fisico)
                                ...
                                <div class="row row-p">
                                    <div class="field">
                                        <input type="text" autocomplete="on" id="referencias" name="referencias"
                                            value="" onchange="this.setAttribute('value', this.value);">
                                ...
                                <div class="row row-p">
                                    <div class="field">
                                        <textarea style="height:200px;resize:vertical;width: 100%" type="text" name="dedicatoria"
                                            placeholder='Dedicatoria (opcional)'></textarea>
                                    </div>
                                    <div style='width:100%;text-align:right;color:#727272;'>*Sujeto a disponibilidad
                                    </div>
                                </div>
                                ...
                                <div class="col-sm">
                                    <div class="field">
                                        <select name="envio" id="envio" value="" onchange="envioSelect()" required>
                                            ...
                                            <option value="{{ $envio->id }}" id="{{ $envio->id }}">${{
                                                number_format($envio->costo, 2 , ".", "," ) }} {{ $envio->nombre }}
                                                @if ($envio->descripcion)- {{ $envio->descripcion }}@endif</option>
                                            @endforeach
                                            @else
                                            <option value="Elegir" id="NA">Lo sentimos, no hay envíos disponibles
                                            </option>
                                            @endif
                                        </select>
                            ...
                            {{-- <div class="row row-p">
                                <div class="col-sm">
                                    <div class="field">
                                        ...
                                        <label for="cupon" title="Ingresar cupón (opcional)"
                                            data-title="Ingresar cupón (opcional)"></label>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="field">
                                        <button onclick="validar()" type="button" class="boton_compra shrink"
                                            id="validarCupon" name="validarCupon" value="validarCupon"
                                                ...
                                                @if ($libro->id == $id)
                                                    ...
                                                    @if ($details['cantidadFisico'] > 0)
                                                        <div class="producto-row">
                                                            <div class="producto-cell imagen-producto">
                                                                <img
                                                                    src="{{ asset('/storage/libros/' . $libro->tiendaImagen) }}">
                                                            </div>
                                                            <div class="producto-cell contenido-producto">
                                                            ...
                                                            <div class="producto-cell contenido-producto-sm">
                                                                <p>${{ number_format(
                                                                    ($libro->precioFisico - $libro->precioFisico * ($libro->descuentoFisico / 100)) * $details['cantidadFisico'],
                                                                    2,
                                                                    '.',
                                                                    ',',
                                                                ) }}
                                                    ...
                                                    @if ($details['cantidadDigital'] > 0)
                                                        <div class="producto-row">
                                                            ...
                                                            <div class="producto-cell contenido-producto-sm">
                                                                <p>${{ number_format($libro->precioDigital - $libro->precioDigital * ($libro->descuentoDigital / 100), 2, '.', ',') }}
                                                                </p>
                                                                @php
                                    ...
                                    <div class="producto-table">
                                        <div class="producto-row">
                                            @if ($fisico)
                                                ...
                                                <div class="totales">
                                                    <p>Envío</p>
                                                    <p id="envio-totales" class="envio-totales">Selecciona el tipo de
                                                        envío</p>
                                                </div>
                                            @else
                                            ...
                                            <div class="totales" id="cuponHTML" style="display: none;">
                                                ...
                                                <p id="cuponDescuento">${{ number_format(0, 2, '.', ',') }}</p>
                                            </div>
                                            <div class="totales">
                                                <p>Total</p>
                    ...
                    if (cupon) {
                        ...
                        if (cupon['minimoCompra']) {
                            ...
                            if (subtotal < cupon['minimoCompra']) {
                                alert('Cupón no válido: Para aplicar este cupón es necesario que su compra sea de al menos $' +
                                    formatearNumero(cupon['minimoCompra']));
                                cuponSeleccionado = 0;
                                return;
                            }
                        }
                        ...
                        if (cupon['reusable'] == 0) {
                            if (cupon['id'] && cuponesUsuario && cuponesUsuario[cupon['id']]) {
                                alert(
                                    'Cupón no válido: Este cupón solamente puede usarse una vez y ya ha sido utilizado en anteriores compras.'
                                );
                                cuponSeleccionado = 0;
                                return;
                            }
                        ...
                        if (cupon['nuevos'] == 1 && !hayNuevo) {
                            alert(
                                'Cupón no válido: Este cupón solamente puede usarse si hay libros nuevos en el carrito. ¡Puedes verlos en la sección de NOVEDADES!'
                            );
                            cuponSeleccionado = 0;
                            return;
                        }
                        ...
                        if (!hayFisico) {
                            ...
                            if (envio) {
                                ...
                                if (envio.value != "") {
                                    ...
                                    return alert(
                                        'Cupón no válido: Para aplicar este cupón es necesario que selecciones un envío.'
                                    );
                                }
                            }
                        }
                            ...
                            case 'total':
                                ...
                                if (cupon['porcentajeDesc']) {
                                    ...
                                    if (!hayFisico) {
                                        ...
                                        document.getElementById("cuponDescuento").innerHTML = "-$" + formatearNumero(
                                            subtotal * (cupon['porcentajeDesc'] / 100));

                                        //se actualiza el total
                                        total.innerHTML = "$" + formatearNumero(totalCosto - subtotal * (cupon[
                                            'porcentajeDesc'] / 100));
                                        ...
                                        alert('Cupón aplicado: Se ha descontado el ' + cupon['porcentajeDesc'] +
                                            '% del total de tu compra!');
                                    } else {
                                        if (envioData["costo"]) {
                                            ...
                                            //se pone la cantidad a descontar
                                            document.getElementById("cuponDescuento").innerHTML = "-$" + formatearNumero(
                                                oldTotal * (cupon['porcentajeDesc'] / 100));

                                            //se actualiza el total
                                            total.innerHTML = "$" + formatearNumero(oldTotal - oldTotal * (cupon[
                                                'porcentajeDesc'] / 100));
                                    ...
                                    if (!hayFisico) {
                                        ...
                                        if (nuevoTotal > 0) {
                                            ...
                                            $('#cupSelHidden').val(cuponSeleccionado);
                                            alert('Cupón aplicado: Se ha descontado la cantidad de $' + formatearNumero(
                                                cupon['valorDesc']) + ' del total de tu compra!');
                                        } else {
                                            //se pone la cantidad a descontar
                                            document.getElementById("cuponDescuento").innerHTML = "-$" + formatearNumero(
                                                totalCosto);
                                        ...
                                        if (envioData["costo"]) {
                                            ...
                                            if (nuevoTotal > 0) {
                                                //se pone la cantidad a descontar
                                                document.getElementById("cuponDescuento").innerHTML = "-$" +
                                                    formatearNumero(cupon['valorDesc']);
                            ...
                            case 'envio':
                                ...
                                if (hayFisico) {
                                    ...
                                    if (cupon['porcentajeDesc']) {
                                        ...
                                        if (envioData["costo"]) {
                                            descuentoEnvioP = envioData["costo"] - (envioData["costo"] * (cupon[
                                                'porcentajeDesc'] / 100));
                                            ...
                                            $('#cupSelHidden').val(cuponSeleccionado);
                                            alert('Cupón aplicado: Se ha descontado el ' + cupon['porcentajeDesc'] +
                                                '% del costo de envío de tu compra!');
                                        }
                                    } else {
                                        //si no entonces se descuenta una cierta cantidad
                                        if (envioData["costo"]) {
                                            ...
                                            if (nuevoTotal > 0) {
                                                ...
                                                $('#cupSelHidden').val(cuponSeleccionado);
                                                alert('Cupón aplicado: Se ha descontado la cantidad de $' + formatearNumero(
                                                    cupon['valorDesc']) + ' del costo de envío de tu compra!');
                                            } else {
                                                //se pone la cantidad a descontar
                                                document.getElementById("cuponDescuento").innerHTML = "-$" +
                                                    formatearNumero(envioData["costo"]);
                                                ...
                                                $('#cupSelHidden').val(cuponSeleccionado);
                                                alert('Cupón aplicado: Se ha descontado la cantidad de $' + formatearNumero(
                                                    envioData["costo"]) + ' del costo de envío de tu compra!');
                                            }
                                        }
                                    }
                                } else {
                                    return alert(
                                        "Cupón no válido: Para poder aplicar este cupón es necesario que tenga libros físicos en su carrito y que seleccione un tipo de envío."
                                    );
                                }
                                break;
                            case 'compra':
                                ...
                                if (cupon['porcentajeDesc']) {
                                    ...
                                    if (!hayFisico) {
                                        ...
                                        if (nuevoTotal > 0) {
                                            ...
                                            $('#cupSelHidden').val(cuponSeleccionado);
                                            alert('Cupón aplicado: Se ha descontado la cantidad de $' + formatearNumero(
                                                cupon['valorDesc']) + ' del subtotal de tu compra!');
                                        } else {
                                            //se pone la cantidad a descontar
                                            document.getElementById("cuponDescuento").innerHTML = "-$" + formatearNumero(
                                                totalCosto);
                                            ...
                                            $('#cupSelHidden').val(cuponSeleccionado);
                                            alert('Cupón aplicado: Se ha descontado la cantidad de $' + formatearNumero(
                                                totalCosto) + ' del subtotal de tu compra!');
                                        }
                                    } else {
                                        if (envioData["costo"]) {
                                            //se calcula el total
