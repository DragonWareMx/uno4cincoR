...
<div class="all_sliders_contenido">
    <a class="text_agregar" style="margin:0px 20px 0px 0px !important; width:100%; text-align:right"
        href="{{ route('nuevoSlider', ['tipo' => 'libro'])}}">Agregar</a>
    <p style="width:100%">El Slider más nuevo es el que será mostrado primero en el inicio de la página. Click sobre un
        slider para eliminarlo</p>
    <!--slider LIBROS-->
    <div id="carruselLibros" class="carousel slide" data-ride="carousel" style="margin-bottom:60px !important">
        <div class="carousel-inner">
            ...
            @endphp
            @endforeach
            <a class="carousel-control-prev flechasPosicion newPosition" data-target="#carruselLibros" data-slide="prev"
                style="cursor: pointer; cursor:hand;">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next flechasPosicion newPosition" data-target="#carruselLibros" data-slide="next"
                style="cursor: pointer; cursor:hand;">
