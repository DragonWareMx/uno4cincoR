...
class gestorLibrosController extends Controller
{
    ...
    public function updateBook($id)
    {
        ...
        if (request('preciodigital')) {
            $book->precioDigital = request('preciodigital');
        } else {
            $book->precioDigital = 0;
        }
        if (request('ofertafisico')) {
            $book->descuentoFisico = request('ofertafisico');
        } else {
            $book->descuentoFisico = 0;
        }
        if (request('ofertadigital')) {
            $book->descuentoDigital = request('ofertadigital');
        } else {
            $book->descuentoDigital = 0;
        }
        $book->sinopsis = request('sinopsis');
